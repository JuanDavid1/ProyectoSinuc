...
<script src="<?php echo $_SESSION['urlin'] ?>/assets/js/jquery.min.js?v=<?php echo date('YmdHis')?>"></script>
<script src="<?php echo $_SESSION['urlin'] ?>/assets/js/jquery.dataTables.min.js?v=<?php echo date('YmdHis')?>"></script>
<script src="<?php echo $_SESSION['urlin'] ?>/assets/js/dataTables.bootstrap5.min.js?v=<?php echo date('YmdHis')?>"></script>
